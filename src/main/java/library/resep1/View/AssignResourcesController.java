...
public class AssignResourcesController {
    ...
    private List<Bus> getAvailableBuses(
        ...
        return tripVM.getAvailableBuses(
                start,
                end,
                busVM.getAllBuses()
        );
    ...
    private List<Chauffeur> getAvailableChauffeurs(
            LocalDateTime start,
            LocalDateTime end
    ) {

        return tripVM.getAvailableChauffeurs(
                start,
                end,
    ...
    private void showEmptyState(
        ...
        emptyStateBox.setVisible(
                true
        );

        emptyStateBox.setManaged(
                true
        );
        ...
        resultsBox.setVisible(
                false
        );

        resultsBox.setManaged(
                false
        );
    }
    ...
    private HBox buildChauffeurRow(
            Chauffeur chauffeur
    ) {
    ...
    public static Result showDialog(
        ...
        try {
            ...
            throw new RuntimeException(
                    ...
                    "Failed to open assign resources dialog",
